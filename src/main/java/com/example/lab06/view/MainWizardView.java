...
public class MainWizardView extends VerticalLayout {
    ...
    public MainWizardView() {
        ...
        create.addClickListener(event -> {
            ...
            Wizard result = WebClient.create()
                    .post()
                    ...
                    .block();
            if(result != null){
                nf = Notification.show("Wizard has been created", 3000, TOP_CENTER);
            } else {
                nf = Notification.show("Can't create Wizard", 3000, TOP_CENTER);
            }
        });
        ...
        update.addClickListener(event -> {
            ...
            String newSchool = school.getValue()+"";
            String newHouse = house.getValue()+"";
            boolean success = WebClient.create()
                    .post()
                    ...
                    .block();
            if(success){
                nf = Notification.show("Wizard has been updated", 3000, TOP_CENTER);
            } else {
                nf = Notification.show("Can't update Wizard", 3000, TOP_CENTER);
            }
        });
        ...
        delete.addClickListener(event -> {
            ...
            boolean success = WebClient.create()
                    ...
                    .block();
            if(success){
                nf = Notification.show("Wizard has been deleted", 3000, TOP_CENTER);
                this.name.setValue("");
                this.gender.setValue("");
                this.position.setValue("");
                this.dollar.setValue(0.00);
                this.house.setValue("");
                this.school.setValue("");
            } else {
                nf = Notification.show("Can't delete Wizard", 3000, TOP_CENTER);
            }
        });
